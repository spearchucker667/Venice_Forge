 ...
 * - VERIFY IDs stay in the documented namespace: VERIFY-001..VERIFY-153 plus
 *   the intentional legacy T-168 bridge id VERIFY-168.
 *
 * Updated 2026-07-18: extended namespace to VERIFY-001..VERIFY-153 for the
 * Document Agent security foundation and renderer/main boundary.
