...
4. Confirm `README.md`, `AGENTS.md`, [LEGAL.md](../LEGAL.md), [SECURITY.md](../../SECURITY.md), [REPOSITORY_TREE.md](../REPOSITORY_TREE.md), `CHANGELOG.md`, `SUPPORT.md`, `PRIVACY.md`, and this checklist match the release.
