...
- [DEVELOPMENT/image-editor-requirements.md](DEVELOPMENT/image-editor-requirements.md) — Image Editor requirements, API mapping and current delivery status; dedicated navigation and single-image editing are implemented locally, advanced controls planned.

- [reference/Venice_swagger_api.yaml](reference/Venice_swagger_api.yaml) — Authoritative local OpenAPI snapshot (`20260814.153445`, user-selected local source; see manifest for version differences) for Venice API requests/responses.
...
- [audits/Records/2026-09-25-theme-engine-theme-system-exhaustive-audit-handoff.md](audits/Records/2026-09-25-theme-engine-theme-system-exhaustive-audit-handoff.md) — 2026-09-25 exhaustive theme engine & theme system audit handoff; archived in `Records/` after full remediation on `main`.
...
- [audits/Records/auditsep23.md](audits/Records/auditsep23.md) — 2026-09-23 Media, Character, Documents, Theme & Status remediation handoff covering workstreams A–I. Moved from `docs/audits/auditsep23.md` after the workstreams were remediated.
- [audits/Records/Venice_Forge_Random_Pet_Rotation_Agent_Handoff.md](audits/Records/Venice_Forge_Random_Pet_Rotation_Agent_Handoff.md) — 2026-09-23 Codex V1 mascot random pet rotation specification and implementation guide. Moved from `docs/audits/` after the feature landed.
...
- [audits/README.md](audits/README.md) — Audit directory policy: current unfinished work in `ROADMAP.md`, immutable evidence in `Records/`.
...
- [reports/historical/summary-of-work-before-2026-09-23.md](reports/historical/summary-of-work-before-2026-09-23.md) — Session ledger copied before the 2026-09-23 compaction. Evidence only. The live ledger is `summary_of_work.md`.
