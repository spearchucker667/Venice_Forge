(function() {
  try {
    ...
    var map = {
      ...
      '--surface': safeToken(t.surface, isVenice ? '#080f15' : isDracula ? '#44475a' : isGruvbox ? '#3c3836' : isRosepine ? '#1f1d2e' : (boot.appearanceMode === 'light' ? '#ffffff' : '#161b22')),
      '--surface-elevated': safeToken(t.surfaceElevated, isVenice ? '#111922' : isDracula ? '#6272a4' : isGruvbox ? '#504945' : isRosepine ? '#26233a' : (boot.appearanceMode === 'light' ? '#ffffff' : '#1c2330')),
      '--border': safeToken(t.border, isVenice ? '#1b2632' : isDracula ? '#6272a4' : isGruvbox ? '#665c54' : isRosepine ? '#403d52' : (boot.appearanceMode === 'light' ? '#d0d7de' : '#2a3140')),
      ...
      '--text-muted': safeToken(t.textMuted, isVenice ? '#687483' : isDracula ? '#6272a4' : isGruvbox ? '#928374' : isRosepine ? '#6e6a86' : (boot.appearanceMode === 'light' ? '#8b949e' : '#6b7686')),
      ...
      '--accent-fg': safeToken(t.accentForeground, isVenice ? '#050a0f' : isDracula ? '#f8f8f2' : isGruvbox ? '#282828' : isRosepine ? '#191724' : '#ffffff'),
