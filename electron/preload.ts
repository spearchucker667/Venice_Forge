...
const veniceForge = {
  ...
  files: {
    ...
    /** VF-CAPABILITY-PROVENANCE: `issueCapabilityUrl({ objectId, scheme })` (above)
     *  asks main to mint a short-lived capability token and return
     ...
     *  raw custom-protocol URLs itself. */
