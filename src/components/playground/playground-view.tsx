  ...
  return (
    <div className="flex h-full">
      <div className="w-[420px] shrink-0 border-r border-white/[0.06] flex flex-col">
        <div className="flex items-center justify-between gap-2 px-3 h-11 border-b border-white/[0.06] var(--color-surface) shrink-0">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <div className="flex items-center gap-2 px-3 h-11 border-b border-white/[0.06] var(--color-surface) shrink-0">
