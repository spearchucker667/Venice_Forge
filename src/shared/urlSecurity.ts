/** @fileoverview Cross-cutting URL/host security utilities used by both the
 *  Electron main process and the Express dev proxy.  Keeping this module in
 *  `src/shared/` prevents the server bundle from depending on `electron/`
 *  files that may import Electron APIs.
 */
