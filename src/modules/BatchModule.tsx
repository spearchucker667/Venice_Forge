        ...
        <div className="flex flex-col gap-6">
          <Field label="Processing Type">
            <select
              ...
              className="w-full bg-surface-elevated border border-border/50 rounded-xl px-4 py-2.5 text-sm font-medium text-text-primary focus:outline-none focus:ring-1 focus:ring-accent transition-colors"
            >
          ...
          <div className="flex flex-wrap gap-3">
            <button
              className="inline-flex items-center justify-center rounded-lg bg-white px-4 py-2 text-sm font-medium text-black transition-colors hover:bg-white/90 focus:outline-none focus:ring-2 focus:ring-accent active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed"
              onClick={runBatch}
              disabled={isRunning}
            ...
            <button className="inline-flex items-center justify-center rounded-lg border border-white/[0.1] bg-transparent px-4 py-2 text-sm font-medium text-white/70 transition-colors hover:bg-white/[0.03] hover:border-white/[0.2] hover:text-white focus:outline-none focus:ring-2 focus:ring-accent active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed" onClick={cancel} disabled={!isRunning}>
              Cancel
            </button>
            <button
              className="inline-flex items-center justify-center rounded-lg border border-white/[0.1] bg-transparent px-4 py-2 text-sm font-medium text-white/70 transition-colors hover:bg-white/[0.03] hover:border-white/[0.2] hover:text-white focus:outline-none focus:ring-2 focus:ring-accent active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed"
              onClick={exportJson}
      ...
      output={
        <div className="rounded-2xl border border-border/40 bg-surface p-6 flex flex-col gap-6">
          <div className="flex items-center justify-between border-b border-border/50 pb-4">
            <h3 className="text-[11px] uppercase tracking-[0.08em] text-white/40 font-semibold">Batch Results</h3>
