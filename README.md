...
| `VERIFY-047`–`VERIFY-051` | Reserved: Phase 2E Scene Composer, 2F RP Studio Polish, 2G Workflow Templates, 2H Storage/Privacy Dashboard, 2I Research Workspace Polish. See `AGENTS.md` for the full description of each guard | `scripts/verify-*.cjs` |
